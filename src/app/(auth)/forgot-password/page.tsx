...
export const metadata: Metadata = {
  title: 'Dayflow - Forgot Password',
  description: 'Reset your Dayflow account password',
}
    ...
    <div className="bg-background min-h-screen flex items-center justify-center p-4 antialiased">
      ...
      <div className="relative z-10 w-full max-w-[480px]">
        ...
        <div className="text-center mb-stack-lg">
          ...
          <p className="font-body-md text-body-md text-on-surface-variant">Account Recovery</p>
        </div>
